import socialLogo from '../content/icons/icon-social.svg';

export default function Social(props) {
    return(
        <div>
            <div className="md:relative bg-social rounded-xl h-full">
                <img className="float-right z-10" src={socialLogo} alt="social" />
                <div className="md:absolute bg-card hover:bg-cardhover rounded-xl h-[77%] md:inset-x-0 md:bottom-0">
                    <div className="columns-2 px-10 py-5">
                        <h1 className="font-light text-white text-2xl">Social</h1>
